...
def _serialize_device_for_cache(device: object) -> dict[str, object]:
    payload = {
        ...
        "state": get_field(device, "state"),
        "in_gateway_mode": get_field(device, "in_gateway_mode"),
        "displayable_version": first_attr(device, "displayable_version", "version"),
        "uptime": get_field(device, "uptime"),
        "num_sta": get_field(device, "num_sta"),
        "system-stats": get_field(device, "system-stats"),
        "general_temperature": get_field(device, "general_temperature"),
        "tx_bytes": get_field(device, "tx_bytes"),
        "rx_bytes": get_field(device, "rx_bytes"),
        "total_max_power": get_field(device, "total_max_power"),
        "stat": get_field(device, "stat"),
